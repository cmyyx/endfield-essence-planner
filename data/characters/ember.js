(function () {
  ...
  window.characters.push({
    ...
    guide: {
      ...
      analysis: 
      "【干员优势】\n\
      站场能力强：容错高，配合战技和连携技的高额免伤以及连携技的治疗可持续站场。\n\
      失衡制造快：技能与连携能稳定叠加破防，且余烬普攻削韧较高，对精英与Boss表现突出。\n\
      连携友好：连携触发条件门槛低，与其他干员配合度高，容易融入各种队伍（例如物理和火队）。\n\
      【操作建议】\n\
      1. 技能释放时机很关键，对齐敌方攻击窗口释放可使免伤收益最大化。\n\
      2. 余烬作为主控角色攻击手感沉重，最好熟练掌握闪避取消后摇。（虽然你不练一般也死不了）",
      teamTips: "",
      operationTips: "",
