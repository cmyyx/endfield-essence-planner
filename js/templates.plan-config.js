          ...
          <div class="plan-config-standalone-body">
            ...
            <div class="plan-config-block">
              <div class="plan-config-block-title">
                ...
                <span v-if="showPlanConfigDisplayRulesHintDot" class="plan-config-hint-dot plan-config-inline-hint-dot" aria-hidden="true">{{ t("plan_config.new_badge") }}</span>
              </div>
