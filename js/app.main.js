  ...
  const app = createApp({
    ...
    setup() {
      ...
      return {
        ...
        optionalFailureHistoryEntryDismissed: state.optionalFailureHistoryEntryDismissed,
        dismissOptionalFailureNotice: state.dismissOptionalFailureNotice,
        dismissOptionalFailureHistoryEntry: state.dismissOptionalFailureHistoryEntry,
